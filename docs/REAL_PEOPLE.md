...
from the pelvis, gathered into folds, fuller behind, with a waistband. Looks with no
...
The same mannequin drives every body: walking, running, fighting, sitting and falling.
The rig handles any skeleton:
